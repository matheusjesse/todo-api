...
describe('Todos', () => {
    ...
    retorna status 200 e um body com a mensagem: ToDo Updated`, () => __awaiter(void 0, void 0, void 0, function* () {
            sinon_1.default.stub(toDos_1.default, "destroy").resolves();
            sinon_1.default.stub(dayPeriod_1.default, "destroy").resolves();
            sinon_1.default.stub(daysOfTheWeek_1.default, "destroy").resolves();
            sinon_1.default.stub(toDos_1.default, "findOne").resolves(todoMock_1.todoPostMockResponse);
